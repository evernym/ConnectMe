...
public class HomePageiOS implements test.java.pageObjects.HomePage {
    ...
    public WebElement credentialOfferNotification(AppiumDriver driver) throws Exception {
      ...
      public WebElement proofRequestNotification(AppiumDriver driver) throws Exception {
        return AppiumUtils.findElement(
          driver,
          "//*[@text=\"Remote connection sent you a Proof Request\"]",
          "Proof Request Notification"
        );
    }

    public WebElement questionNotification(AppiumDriver driver) throws Exception {
      return AppiumUtils.findElement(
        driver,
      "//*[@text=\"Remote connection sent you a Question\"]",
